			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="subscription.buyer.label" default="Buyer" /></th>
					
						<th><g:message code="subscription.seller.label" default="Seller" /></th>
				...
				<g:each in="${subscriptionInstanceList}" status="i" var="subscriptionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${subscriptionInstance.id}">${fieldValue(bean: subscriptionInstance, field: "buyer")}</g:link></td>
					
						<td>${fieldValue(bean: subscriptionInstance, field: "seller")}</td>
